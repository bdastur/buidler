...
class BuilderUT(unittest.TestCase):
                ...
                "html": {
                    "index": {
                        ...
                        "components": {
                            ...
                            "simplebutton": {"type": "button", "name": "submit"},
                        },
                    }
                },
                "app": {
    ...
    def testParserInitialize(self):
        ...
        self.assertEqual(
            parserObj.parsedData.keys(), dataKeys,
            msg="Unexpected keys!")
    ...
    def testRenderer(self):
        ...
        renderObj = renderer.Renderer()
        flaskRendererObj = flask_renderer.FlaskRenderer(
            configFile, templateRoot="../templates"
        )
    ...
    def testNewRenderHtml(self):
        ...
        self.assertEqual(
            flaskRendererObj.initialized, False, "Expected initializedFalse"
        )
        ...
        self.assertEqual(
            flaskRendererObj.initialized, False, "Exepcted initialized True"
        )
        ...
        self.assertEqual(
            flaskRendererObj.initialized, True, "Exepcted initialized True"
        )
